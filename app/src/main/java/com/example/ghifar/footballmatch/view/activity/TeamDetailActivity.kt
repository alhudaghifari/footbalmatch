...
class TeamDetailActivity : AppCompatActivity(), TeamInterface {

    private val TAG = TeamDetailActivity::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.statusBarColor = ContextCompat
                    .getColor(this@TeamDetailActivity, R.color.blackandblue2)
        }
